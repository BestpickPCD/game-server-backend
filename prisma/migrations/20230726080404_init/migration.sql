...
CREATE TABLE `Agents` (
    ...
    UNIQUE INDEX `Agents_username_key`(`username`),
    INDEX `Agents_parentAgentId_fkey`(`parentAgentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `UserAgentRelation` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `userId` INTEGER NOT NULL,
    `agentId` INTEGER NOT NULL,

    INDEX `UserAgentRelation_userId_fkey`(`userId`),
    INDEX `UserAgentRelation_agentId_fkey`(`agentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `UserAgentRelation` ADD CONSTRAINT `UserAgentRelation_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `Users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `UserAgentRelation` ADD CONSTRAINT `UserAgentRelation_agentId_fkey` FOREIGN KEY (`agentId`) REFERENCES `Agents`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
