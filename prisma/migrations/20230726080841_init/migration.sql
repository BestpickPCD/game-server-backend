...
CREATE TABLE `agent_user` (
    ...
    INDEX `agent_user_userId_fkey`(`userId`),
    INDEX `agent_user_agentId_fkey`(`agentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `agent_user` ADD CONSTRAINT `agent_user_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `Users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `agent_user` ADD CONSTRAINT `agent_user_agentId_fkey` FOREIGN KEY (`agentId`) REFERENCES `Agents`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
